        ...
        <div class="container mx-auto px-4 py-10">
            ...
            <div class="flex justify-between items-center flex-wrap">
                ...
                <div class="text-xs py-1 px-3 rounded mb-4">
                    <span>Tomáš Jedno | CC BY-SA-NC 4.0</span>
                </div>
            </div>
            ...
            <div class="text-center sm:text-left">
                <div class="flex justify-center sm:justify-start flex-wrap">
                    <div class="mb-4">
                        <h1 class="text-2xl font-bold uppercase">Vánoční posezení pedagogické katedry ZČU</h1>
                        <p class="text-2xl font-bold mt-2">11.12.</p>
